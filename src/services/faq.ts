...
const ensureArray = (payload: any): FaqArticle[] => {
...
export async function getPopularFaqArticles(): Promise<FaqArticle[]> {
  try {
...
export async function sendFaqFeedback(id: string, payload: Record<string, unknown>) {
  try {
